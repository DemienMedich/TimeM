...
4. Добавьте описание: "Приложение на C++ для управления временем и борьбы с прокрастинацией"
...
git commit -m "Первый коммит: Приложение для управления временем и борьбы с прокрастинацией"
